...
class BaseDataset(Dataset):
    ...
    def __init__(self, index, cfg, wave_augs, limit=None, identical_mix_proba=0.005):
        self.identical_mix_proba = identical_mix_proba
        self.cfg = cfg
    ...
    def __getitem__(self, ind):
        ...
        if np.random.uniform() <= self.identical_mix_proba:
            item_dict["mix_audio"] = item_dict["target_audio"].detach().clone()
